...
keywordTest("BEFORE", SyntaxKind.IDENTIFIER), // sadly this is used by natunit as a subroutine name :(
...
keywordTest("LOG", SyntaxKind.IDENTIFIER), // sadly this is used my natunit as a subroutine name :(
