...
public class LexerShould
{
	...
	@Nested
	class LexSingleCharacterOperatorTokens
	{
		@TestFactory
	...
	@Nested
	class LexMultiCharacterOperatorTokens
	{
		@TestFactory
		Iterable<DynamicTest> lexMultiCharacterTokens()
		{
			return Arrays.asList(
				dynamicTest("Greater Equals", () -> assertTokens(">=", token(SyntaxKind.GREATER_EQUALS, ">="))),
				...
				dynamicTest("gE", () -> assertTokens("gE", token(SyntaxKind.GE, "gE"))),
				dynamicTest("Ge", () -> assertTokens("Ge", token(SyntaxKind.GE, "Ge"))),
				dynamicTest("Less Equals", () -> assertTokens("<=", token(SyntaxKind.LESSER_EQUALS, "<="))),
	...
	{
		@TestFactory
		Iterable<DynamicTest> withoutDecimalDelimiter()
		{
			return Arrays.asList(
		...
		@TestFactory
		Iterable<DynamicTest> withDecimalPoint()
		{
			return Arrays.asList(
		...
		@TestFactory
		Iterable<DynamicTest> withDecimalComma()
		{
			return Arrays.asList(
				dynamicTest("1", () -> assertTokens("1", token(SyntaxKind.NUMBER, "1"))),
				dynamicTest("1,0", () -> assertTokens("1,0", token(SyntaxKind.NUMBER, "1,0"))),
