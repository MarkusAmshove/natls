...
public interface IDiagnostic extends IPosition
{
	 ...
	 *
	 * Returns the original position where the Diagnostic appeared for purposes of <strong>printing both
	 * locations</strong>. </br>
	 * This only differs from the Diagnostics own position if the diagnostic was e.g. raised in a copycode. </br>
	 * In that case, the Diagnostics own position should be on the INCLUDE, while the originalPosition should return the
	 * position within the copy code where the issue was raised. </br>
