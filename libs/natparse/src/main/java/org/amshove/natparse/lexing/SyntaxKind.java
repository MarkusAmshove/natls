...
public enum SyntaxKind
{
	...
	APPLIC_ID(true, true, false),
	INIT_ID(true, true, false),
	TIMX(true, true, false),
	TIMD(true, false, true),
	TIMN(true, true, false),
	TIME_OUT(true, true, false),
	DATD(true, true, false),
	DATG(true, true, false),
	DATE(true, true, false),
	DAT4E(true, true, false),
	DAT4I(true, true, false),
	DATI(true, true, false),
	DAT4J(true, true, false),
	DATJ(true, true, false),
	DAT4D(true, true, false),
	LANGUAGE(true, true, false),
	DATX(true, true, false),
	DATN(true, true, false),
	DATU(true, true, false),
	DAT4U(true, true, false),
	DATV(true, true, false),
	DATVS(true, true, false),
	STARTUP(true, true, false),
	STEPLIB(true, true, false),
	PAGE_NUMBER(true, true, true),
	WINDOW_PS(true, true, false),
	LIBRARY_ID(true, true, false),
	LINEX(true, true, false),
	LINE_COUNT(true, true, true),
	LINESIZE(true, true, false),
	MACHINE_CLASS(true, true, false),
	PAGESIZE(true, true, false),
	SV_ISN(true, true, true),
	CURRENT_UNIT(true, true, false),
	OCC(true, false, true),
	OCCURRENCE(true, false, true),
	ERROR_NR(true, true, false),
	SV_ERROR(true, true, false), // *ERROR is equivalent of *ERROR-NR
	ERROR_LINE(true, true, false),
	ERROR_TA(true, true, false),
	LINE(true, true, false),
	TRIM(true, false, true),
	MAXVAL(true, false, true),
	MINVAL(true, false, true),
	CURS_LINE(true, true, false),
	CURS_COL(true, true, false),
	CURS_FIELD(true, true, false),
	SV_DATA(true, true, false),
	SV_LEVEL(true, true, false),
	SV_NUMBER(true, true, true),
	SV_LENGTH(true, false, true),
	TRANSLATE(true, false, true),
	TIMESTMP(true, true, false),
	PF_KEY(true, true, false),
	INIT_PROGRAM(true, true, false),
	INIT_USER(true, true, false),
	SV_USER(true, true, false),
	COUNTER(true, true, true),
	COM(true, true, false),
	DEVICE(true, true, false),
	OPSYS(true, true, false),
	TPSYS(true, true, false),
	PROGRAM(true, true, false),
	ETID(true, true, false),
	CPU_TIME(true, true, false),
	LBOUND(true, true, false),
	UBOUND(true, true, false),
	SERVER_TYPE(true, true, false),
	...
	PA1(true, false, false),
	PA2(true, false, false),
	PA3(true, false, false),
	PC(true, false, false),
	PD(true, false, false),
