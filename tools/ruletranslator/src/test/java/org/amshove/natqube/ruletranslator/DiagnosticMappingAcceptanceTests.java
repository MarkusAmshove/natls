...
class DiagnosticMappingAcceptanceTests
{
	...
	private static final List<String> VALID_TAGS = List.of("natparse-internal", "performance", "brain-overload", "bad-practice", "cert", "clumsy", "confusing", "convention", "cwe", "design", "lock-in", "owasp", "pitfall", "sans-top25", "suspicious", "unpredictable", "unused", "user-experience");
